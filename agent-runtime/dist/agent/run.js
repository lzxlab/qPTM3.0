...
import { mergeClarification, applyClarificationToMemory, } from "./clarification.js";
...
export async function* runAgent(opts) {
    ...
    let body = "";
    try {
        for await (const chunk of composeAnswer(userMessage, opts.history, session.memory, artifacts, citations)) {
    ...
    const followUps = await generateFollowUps(userMessage, answer, session.memory, artifacts, "qa", toolsUsed);
